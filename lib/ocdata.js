var mongoose = require('mongoose')
  , Agency = require('../models/Agency') // mongoose.model('Agency')
  , Calendar = require('../models/Calendar')  // mongoose.model('Calendar')
  , CalendarDate = require('../models/CalendarDate') // mongoose.model('CalendarDate')
  , Route = require('../models/Route') // mongoose.model('Route')
  , Stop = require('../models/Stop')  // mongoose.model('Stop')
  , StopTime = require('../models/StopTime') // mongoose.model('StopTime')
  , Trip = require('../models/Trip') // mongoose.model('Trip')
  , async = require('async')
